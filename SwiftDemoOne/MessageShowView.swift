...
class MessageShowView: UIView,UIScrollViewDelegate {
    ...
    private var leftBtnImage:MessageShowBtnImage!
    private var rightBtnImage:MessageShowBtnImage!
    private var middleBtnImage:MessageShowBtnImage!
    ...
    override func didMoveToWindow() {
        ...
        //初始化三个imageView
        leftBtnImage = MessageShowBtnImage.init(frame: CGRect(x:0,y:0,width:self.frame.size.width,height:self.frame.size.height))
        middleBtnImage = MessageShowBtnImage.init(frame: CGRect(x:leftBtnImage.frame.maxX,y:0,width:self.frame.size.width,height:self.frame.size.height))
        rightBtnImage = MessageShowBtnImage.init(frame: CGRect(x:middleBtnImage.frame.maxX,y:0,width:self.frame.size.width,height:self.frame.size.height))
